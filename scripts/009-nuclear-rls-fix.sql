...
-- 009-nuclear-rls-fix.sql
-- Políticas RLS amplas para desenvolvimento (NÃO USAR EM PRODUÇÃO)
-- Exemplo: Permitir acesso total para todos os usuários autenticados
-- Adicione CREATE POLICY para cada tabela
